...
| --- | --- | --- |
| `port-terminal.jpg` | PortCalls Asia | [Cargo ships and shipping containers at a port](https://unsplash.com/photos/cargo-ships-and-shipping-containers-at-a-port-LMzUSxK24bg) |
| `tanker-dusk.jpg` | Dylan McLeod | [Oil tanker ship](https://unsplash.com/photos/oil-tanker-ship-4zqvu9dyvSk) |
...
| `diversified-trade-panorama-hd-truck-fix.webp` | OpenAI image generation + Real-ESRGAN restoration + localized OpenAI image edit | Approved 3840px contextual panorama integrating general trading goods, energy infrastructure and logistics in one fictional industrial district; the final edit repairs the central truck and immediate road region |
